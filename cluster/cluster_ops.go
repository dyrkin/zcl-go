...
// func (c *ClusterLibrary) LocalFrame(clusterQuery ClusterQuery, commandQuery CommandQuery, args ...interface{}) (f *frame.Frame, err error) {
...
// func (c *ClusterLibrary) GlobalFrame(commandExtractor CommandExtractor, args ...interface{}) (f *frame.Frame, err error) {
...
// func (c *ClusterLibrary) FromFrame(clusterId ClusterId, f *frame.Frame) (interface{}, error) {
