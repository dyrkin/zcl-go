...
func zclGetDataTypeLength(dataType ZclDataType) uint8 {
	switch dataType {
	case ZclDataTypeData8, ZclDataTypeBoolean, ZclDataTypeBitmap8, ZclDataTypeInt8,
		ZclDataTypeUint8, ZclDataTypeEnum8:
		return 1

	case ZclDataTypeData16, ZclDataTypeBitmap16, ZclDataTypeUint16, ZclDataTypeInt16,
		ZclDataTypeEnum16, ZclDataTypeSemiPrec, ZclDataTypeClusterId, ZclDataTypeAttrId:
		return 2

	case ZclDataTypeData24, ZclDataTypeBitmap24, ZclDataTypeUint24, ZclDataTypeInt24:
		return 3

	case ZclDataTypeData32, ZclDataTypeBitmap32, ZclDataTypeUint32, ZclDataTypeInt32,
		ZclDataTypeSinglePrec, ZclDataTypeTod, ZclDataTypeDate, ZclDataTypeUtc, ZclDataTypeBacOid:
		return 4

	case ZclDataTypeUint40, ZclDataTypeInt40:
		return 5

	case ZclDataTypeUint48, ZclDataTypeInt48:
		return 6

	case ZclDataTypeUint56, ZclDataTypeInt56:
		return 7

	case ZclDataTypeDoublePrec, ZclDataTypeIeeeAddr, ZclDataTypeUint64, ZclDataTypeInt64:
		return 8

	case ZclDataType_128BitSecKey:
		return 16

	case ZclDataTypeNoData, ZclDataTypeUnknown:
		fallthrough
	default:
		return 0
	}
